...
Need to submit a Word document to your manager or a journal? [Quarto can use your company's Word template](https://quarto.org/docs/output-formats/ms-word-templates.html) and output a perfectly formatted DOCX file. Your content stays in markdown; the presentation adapts to whatever template you specify.
