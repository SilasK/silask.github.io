...
Ok, now let's use multiple sample for binning. Inspired by this article I set co-abundance binning as the default in my [**Metagenome-Atlas**] 
...
However, this this ***cross-mapping*** is quite ressource intensive. Some would suggest this is the best approach and don't care about scalability. 
But there is another approach: ***co-binning***, also called _multi-split_ by the authors who first used it [@doi:10.1038/s41587-020-00777-4] .
...
I've seen that the authors of VAMB developped a new 
