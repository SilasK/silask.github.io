---
title: "The easiest way to run jobs on a HPC cluster!"
date: "2025-08-04"
categories: 
  - Snakemake
  - Bioinformatics
...
![This graph shows only the rules. In practice most nodes would be multiplied by the number of samples, but this will give an very complicated graph.](rulegraph.svg)
...
1. [Snakemake Documentation](https://snakemake.readthedocs.io/en/stable/)
1. [Snakemake Tutorial](https://snakemake.readthedocs.io/en/stable/tutorial/tutorial.html)
1. I can help you with the rest.  
